...
def makeSetting(Dataset, measure, ytickMeasure):
    ...
    settings.append({"Dataset":Dataset, "mop":"MOP4", "measure":measure, "marker":"o", "color":"brown", "size":200, "x":None, "y":None, "label":"MOP4 ($\it{f₁, f₂, f₃, f₄}$)", "ytick":ytickMeasure})
...
def manuFigSetting():
    ...
    settings["Gmean_Dtra"] = {"xMin" : 2, "xMax" : 30, "yMin" : 0.1, "yMax" : 0.75}
    settings["Gmean_Dtst"] = {"xMin" : 2, "xMax" : 30, "yMin" : 0.1, "yMax" : 0.75}
    settings["FPR_Dtra"] = {"xMin" : 2, "xMax" : 30, "yMin" : 0, "yMax" : 0.25}
    settings["FPR_Dtst"] = {"xMin" : 2, "xMax" : 30, "yMin" : 0, "yMax" : 0.25}
    settings["PPV_Dtra"] = {"xMin" : 2, "xMax" : 30, "yMin" : 0, "yMax" : 0.35}
    settings["PPV_Dtst"] = {"xMin" : 2, "xMax" : 30, "yMin" : 0, "yMax" : 0.35}
...
def plotAveragePopulation_Results(settingList):
    ...
    yMin = setting[measure]["yMin"]
    yMax = setting[measure]["yMax"]
    ...
    axes.set_xlabel("Minimize $\it{f₂}$ (Number of rules)", fontsize = 25)
    axes.set_ylabel(setting["ytick"], fontsize = 25)
    plt.legend()
    plt.show()
