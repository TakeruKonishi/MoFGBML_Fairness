 ...
 *
 */
public class MOP7_fairness<michiganSolution extends MichiganSolution<?>>
        ...
        public MOP7_fairness(
       	...
       	public void evaluate(PittsburghSolution_Basic<michiganSolution> solution) {
    		...
    		/* The third objective */
    		FalsePositiveRateDifference<PittsburghSolution_Basic<michiganSolution>> function3 = new FalsePositiveRateDifference<PittsburghSolution_Basic<michiganSolution>>();
    		double f3 = function3.function(solution, train);
    		/* The fourth objective */
    		PositivePredictiveValuesDifference<PittsburghSolution_Basic<michiganSolution>> function4 = new PositivePredictiveValuesDifference<PittsburghSolution_Basic<michiganSolution>>();
    		double f4 = function4.function(solution, train);
...
//    			throw new ArithmeticException("This PittsburghSolution has no michiganSolution");
    	...
    	public String toString() {
    		return "MOP7_fairness [michiganSolutionBuilder=" + michiganSolutionBuilder
